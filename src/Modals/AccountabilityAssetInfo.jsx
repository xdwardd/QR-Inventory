      ...
      <React.Fragment>
        ...
        >
          ...
          <DialogActions sx={{ marginBottom: "1rem", marginRight: "1rem" }}>
            {selectedRow?.status ==
              "USER-ASSIGNMENT: DEPARTMENT HEAD APPROVED" && (
              <>
                <Button
                  sx={{
                    paddingTop: "8px",
                  ...
                  variant="outlined"
                  color="success"
                  onClick={() => setOpenAcknowledgeAccountability(true)}
                >
                  Acknowledge
                </Button>
                <Button
                  ...
                  variant="outlined"
                  color="error"
                  onClick={() => setOpenDeclinedAccountability(true)}
                >
                  Declined
                </Button>
              </>
...
export default AccountabilityAssetInfo;
